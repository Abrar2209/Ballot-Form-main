...
const Integration = ({ klaviyoIntegration }) => {
  ...
  // console.log("console.log(fieldsLabels);", fieldsLabels);
...
{
  /* <SubmitForm name="First Name" options={fieldsLabel} /> */
}
{
  /* <SubmitForm
        name={nameOfFields.map((name) => (
...

{
  /* <Select
                              options={fieldsLabel}
                              onChange={(e) => handleKlaviyoIntegration('klaviyoIntegration', 'klaviyoListMapping', {
