...
import { DeleteMinor, CaretUpMinor, CaretDownMinor, DragHandleMinor } from "@shopify/polaris-icons";
        ...
        {open && (
          <div className="checkbox-container">
            ...
            <div className="checkbox-label">
              ...
              {(required && hideLabel) && (<div className="checkbox-check-inputs">
                <input
                  className="checkbox-input"
                  type="checkbox"
